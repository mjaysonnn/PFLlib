...
| 250  | 10  | Spot(p20_q5) | `View4` | Done
| 250  | 10  | Spot(p20_q10) | `View5` | Done
| 250  | 10  | Spot(p20_q15) | `Jisoo1`  | Done
| 250  | 10  | Spot(p20_q20) | `Jisoo2`  | Done

| 125  | 20 | Spot(p20_q5) | `Jisoo3`  | Done
| 125  | 20 | Spot(p20_q10) | `Jisoo4`  | Done
| 125  | 20 | Spot(p20_q15) | `Jisoo5`  | Done
| 125  | 20 | Spot(p20_q20) | `View1`   | Done
...
# python main.py -data Cifar10 -m ResNet18 -algo FedAvg -gr 125 -ls 20 -nc 100 -jr 0.2 --on_demand_clients 20 --spot_clients 0 -lr 0.01 -lbs 32 -go "non_iid_resnet18_e20_uniform_pathological_fedavg"

# SCAFFOLD - 125 rounds, 20 local steps
# python main.py -data Cifar10 -m ResNet18 -algo SCAFFOLD -gr 125 -ls 20 -nc 100 -jr 0.2 --on_demand_clients 20 --spot_clients 0 -lr 0.01 -slr 1.0 -lbs 32 -go "non_iid_resnet18_e20_uniform_pathological_scaffold"

# Spot (On-Demand: 20, Spot: 5, -jr=0.25)
# python main.py -data Cifar10 -m ResNet18 -algo FedAvg -gr 125 -ls 20 -nc 100 -jr 0.25 --on_demand_clients 20 --spot_clients 5 -lr 0.01 -lbs 32 -go "non_iid_resnet18_e20_uniform_pathological_spotq5"

# Spot (On-Demand: 20, Spot: 10, -jr=0.3)
# python main.py -data Cifar10 -m ResNet18 -algo FedAvg -gr 125 -ls 20 -nc 100 -jr 0.3 --on_demand_clients 20 --spot_clients 10 -lr 0.01 -lbs 32 -go "non_iid_resnet18_e20_uniform_pathological_spotq10"

# Spot (On-Demand: 20, Spot: 15, -jr=0.35)
# python main.py -data Cifar10 -m ResNet18 -algo FedAvg -gr 125 -ls 20 -nc 100 -jr 0.35 --on_demand_clients 20 --spot_clients 15 -lr 0.01 -lbs 32 -go "non_iid_resnet18_e20_uniform_pathological_spotq15"

# Spot (On-Demand: 20, Spot: 20, -jr=0.4)
# python main.py -data Cifar10 -m ResNet18 -algo FedAvg -gr 125 -ls 20 -nc 100 -jr 0.4 --on_demand_clients 20 --spot_clients 20 -lr 0.01 -lbs 32 -go "non_iid_resnet18_e20_uniform_pathological_spotq20"
```

...
generate_noniid_data() {
    echo "Generating non-IID CIFAR-10 data with $1 clients..."
    cd ../dataset
...
generate_noniid_data 20
python main.py -data Cifar10 -m ResNet18 -algo FedAvg -gr 250 -ls 10 -nc 20 -jr 1.0 --on_demand_clients 5 --spot_clients 15 -lr 0.01 -lbs 32 -go "ResNet18_e10_poisson_dirichlet_m20_p5q15"
...
generate_noniid_data 20
python main.py -data Cifar10 -m ResNet18 -algo FedAvg -gr 125 -ls 20 -nc 20 -jr 1.0 --on_demand_clients 5 --spot_clients 15 -lr 0.01 -lbs 32 -go "ResNet18_e20_poisson_dirichlet_m20_p5q15"

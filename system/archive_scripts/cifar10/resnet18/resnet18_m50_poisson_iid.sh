...
generate_data 80
python main.py -data Cifar10 -m ResNet18 -algo FedAvg -gr 250 -ls 2 -nc 80 -jr 1.0 --on_demand_clients 10 --spot_clients 70 -lr 0.01 -lbs 32 -go "ResNet18_e2_iid_poisson_m50_p10q70"
# Spot(p10_q80) - 250 rounds, 2 local steps 
generate_data 90
python main.py -data Cifar10 -m ResNet18 -algo FedAvg -gr 250 -ls 2 -nc 90 -jr 1.0 --on_demand_clients 10 --spot_clients 80 -lr 0.01 -lbs 32 -go "ResNet18_e2_iid_poisson_m50_p10q80"

...
MODEL="CNN"
PARTITION_TYPE="pat"          # Pathological partitioning
...
# Function to generate non-IID Pathological data with specified number of clients
generate_data() {
...
echo "Starting Pathological experiments with dataset: ${DATASET}, model: ${MODEL}, 1000 rounds, 1 local step"

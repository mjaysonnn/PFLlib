...
| 🟢 2500  | 1  | Spot(p20_q20) | `Jisoo2` (Done) -> `Jisoo2` (1335) |
|  1250  | 2  | FedAvg |  |
|  1250  | 2  | SCAFFOLD |  |
|  1250  | 2  | Spot(p20_q5) | `Jisoo3` (Done) -> `Jisoo3` (Done) |
| 🟢 1250  | 2  | Spot(p20_q10) | `Jisoo4` (Done) -> `Jisoo4`|
| 🟢 1250  | 2  | Spot(p20_q15) | `View1` (Done) -> `Jisoo5` (1137) |
| 🟢 1250  | 2  | Spot(p20_q20) | `View2` (Done) -> `View1` (1078) |
|  500   | 5  | FedAvg |  |
|  500   | 5  | SCAFFOLD |  |
...
| 🟢 250  | 10  | Spot(p20_q10) | `View4` (Done) -> `View2` |
| 🟢 250  | 10  | Spot(p20_q15) | `View5` (Done) -> `Jisoo3` |
...
python main.py -data Cifar10 -m ResNet18 -algo FedAvg -gr 250 -ls 10 -nc 100 -jr 0.2 --on_demand_clients 20 --spot_clients 0 -bt 0.5 -lr 0.01 -lbs 32 -go "iid_resnet18_e10_fedavg"
